...
public class AksharaGanaViewImpl<T> extends Composite  implements ChandasView<T>{
  ...
  interface AksharaGanaViewUiBinder extends UiBinder<Widget, AksharaGanaViewImpl> {
  }
  @UiField
  Button button;

  public AksharaGanaViewImpl() {
